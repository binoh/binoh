<?php /* Smarty version Smarty-3.1.11, created on 2013-01-14 13:15:56
         compiled from "C:\wamp\www\b\template\member_co.html" */ ?>
<?php /*%%SmartyHeaderCode:2348650f4050c219316-05622499%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b009cd6c2fd9302e8cc9366cd3631670d60dc614' => 
    array (
      0 => 'C:\\wamp\\www\\b\\template\\member_co.html',
      1 => 1358134761,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2348650f4050c219316-05622499',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_50f4050c5396f0_48926382',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_50f4050c5396f0_48926382')) {function content_50f4050c5396f0_48926382($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html>
<head>
        ...
        <div id="content">
            ...
            <div class="col col_13 checkout">
             <table width="99%" border="0" align="center"  cellpadding="3" cellspacing="1" class="table_style">
                <tr>
                  <td width="25%" class="left_title">订单名称</td>
                  <td width="25%" class="left_title">商品价格</td>
                  <td width="25%" class="left_title">商品剩余</td>
                  <td width="24%" class="left_title">取消收藏</td>
                </tr>
                <?php if (isset($_smarty_tpl->tpl_vars['smarty']->value['section']['name'])) unset($_smarty_tpl->tpl_vars['smarty']->value['section']['name']);
$_smarty_tpl->tpl_vars['smarty']->value['section']['name']['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['co_good']->value) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
                <tr>
                 <td width="25%"><?php echo $_smarty_tpl->tpl_vars['co_good']->value[$_smarty_tpl->getVariable('smarty')->value['section']['name']['index']]['g_name'];?>
</td>
                  <td width="25%"><?php echo $_smarty_tpl->tpl_vars['co_good']->value[$_smarty_tpl->getVariable('smarty')->value['section']['name']['index']]['g_price'];?>
</td>
                  <td width="25%"><?php echo $_smarty_tpl->tpl_vars['co_good']->value[$_smarty_tpl->getVariable('smarty')->value['section']['name']['index']]['g_last'];?>
</td>
                  <td width="24%"><a href="member_do.php?do=quxiao&g_id=<?php echo $_smarty_tpl->tpl_vars['co_good']->value[$_smarty_tpl->getVariable('smarty')->value['section']['name']['index']]['g_id'];?>
">取消收藏</a></td>
               </tr>
               <?php endfor; else: ?>
               <tr>
